...
export const SERVICES_LIST = [
  ...
  "Desentupimento de esgoto e tubulações",
  "Limpeza de caixa de gordura",
  "Hidrojateamento de alta pressão",
  "Inspeção com câmera",
  "Desentupimento de esgoto em galpões industriais",
  "Desentupimento em fábricas e indústrias",
  "Desentupimento de drenagem em estacionamentos",
  "Manutenção preventiva para comércios",
  "Hidrojateamento para rede pluvial"
];
