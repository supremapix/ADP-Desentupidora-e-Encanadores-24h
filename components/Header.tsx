         ...
         <div className="absolute top-full left-0 bg-white shadow-xl border-t-4 border-primary min-w-[200px] z-50 animate-fade-in origin-top">
            {dropdownKey === 'bairros' ? (
              ...
              <div className="flex flex-col py-2">
                 ...
                 <Link to="/#servicos" className="px-4 py-2 hover:bg-gray-50 text-gray-700 transition-colors border-l-2 border-transparent hover:border-primary">Limpeza de Fossa</Link>
      ...
      <div className="container mx-auto px-4 h-28 flex items-center justify-between">
        ...
        <div className="hidden xl:flex items-center gap-4">
          ...
          <div className="flex gap-2">
             <a href="https://wa.me/5541985171966" className="text-green-500 text-2xl transition-all duration-300 hover:scale-110" title="WhatsApp">
               <i className="fab fa-whatsapp"></i>
             </a>
             <a href="tel:4133451194" className="text-primary text-2xl transition-all duration-300 hover:scale-110" title="Ligar">
